...
namespace UI.Views
{
    public partial class FormTeachAddQuestion : Form, IQuestionView
    {
        ...
        public FormTeachAddQuestion()
        {
            InitializeComponent();
            Load += FormTeachAddQuestion_Load;
        }
        public FormTeachAddQuestion(UI.Presenters.MainPresenter.LoadAll hamin)
        {
            HamLoadAll = hamin;
            InitializeComponent();
            Load += FormTeachAddQuestion_Load;
        }
        private void FormTeachAddQuestion_Load(object sender, EventArgs e)
        {
            question_presenter = new QuestionPresenter(this);
            LoadGrade();
            LoadSubject();
            LoadDifficult();
        ...
        {
            QuestionEvent_Add_Question?.Invoke(this, null);
            this.HamLoadAll();
        }
    }
}
